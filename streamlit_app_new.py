...
#     # Option to change video type after loading
#     new_video_type = st.selectbox(
#         "Change video type",
#         ["general", "educational", "interview", "technical"],
#         index=["general", "educational", "interview", "technical"].index(st.session_state["video_type"])
#     )
    
#     if new_video_type != st.session_state["video_type"]:
#         if st.button("Update Video Type"):
#             st.session_state["video_type"] = new_video_type
#             st.success(f"Video type updated to: {new_video_type}")
